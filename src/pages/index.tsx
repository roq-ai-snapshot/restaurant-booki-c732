  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine - Streamlining your dining experience by offering a seamless platform for table reservations and efficient restaurant management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine - Streamlining your dining experience by offering a seamless platform for table reservations and efficient restaurant management.`}
            </Text>
            <Box
